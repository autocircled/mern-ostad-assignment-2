export default function Call2Action() {
    return (
        <section className="call2action bg-success-subtle py-5">
            <div className="container text-center">
                <h2 className="mb-4">READY TO <strong>GROW YOUR BUSINESS?</strong></h2>
                ...
                <div className="row">
                    <div className="col-md-12">
                        <button type="button" className="btn btn-outline-primary">
                            ...
                            <span className="ms-2">GET FREE PROPOSAL</span>
                        </button>
                        ...
                        <button type="button" className="btn btn-outline-dark">
                            ...
                            <span className="ms-2">CALL 866.908.4748</span>
                        </button>
                    </div>
                </div>
            </div>
